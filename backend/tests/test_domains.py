...
class TestDomainRegister:
    ...
    async def test_default_method_is_file(
        self, client: AsyncClient, auth_headers: dict
    ):
        resp = await client.post(
            URL, json={"domain": "example.com"}, headers=auth_headers
        )
        assert resp.status_code == 201
    ...
    async def test_duplicate_domain_returns_409(
        self, client: AsyncClient, auth_headers: dict
    ):
    ...
    async def test_dns_method_accepted(
        self, client: AsyncClient, auth_headers: dict
    ):
        resp = await client.post(
            URL,
    ...
    async def test_invalid_method_returns_422(
        self, client: AsyncClient, auth_headers: dict
    ):
        resp = await client.post(
            URL,
...
class TestDomainList:
    async def test_returns_user_domains(
        self, client: AsyncClient, auth_headers: dict
    ):
    ...
    async def test_user_sees_only_their_domains(
        self, client: AsyncClient, auth_headers: dict
    ):
        await client.post(URL, json={"domain": "a.com"}, headers=auth_headers)
...
class TestDomainGet:
    async def test_returns_domain_by_id(
        self, client: AsyncClient, auth_headers: dict
    ):
        created = (
            await client.post(URL, json={"domain": "example.com"}, headers=auth_headers)
    ...
    async def test_404_for_unknown_domain(
        self, client: AsyncClient, auth_headers: dict
    ):
        resp = await client.get(f"{URL}/9999", headers=auth_headers)
        assert resp.status_code == 404

    async def test_403_for_other_users_domain(
        self, client: AsyncClient, auth_headers: dict
    ):
        created = (
            await client.post(URL, json={"domain": "example.com"}, headers=auth_headers)
...
class TestDomainVerify:
    async def test_file_verification_success(
        self, client: AsyncClient, auth_headers: dict
    ):
        created = (
            await client.post(
        ...
        with patch(_HTTPX, return_value=mock_cm):
            resp = await client.post(
                f"{URL}/{created['id']}/verify", headers=auth_headers
            )
    ...
    async def test_file_verification_404_returns_400(
        self, client: AsyncClient, auth_headers: dict
    ):
        created = (
            await client.post(
    ...
    async def test_already_verified_idempotent(
        self, client: AsyncClient, auth_headers: dict
    ):
        created = (
            await client.post(
